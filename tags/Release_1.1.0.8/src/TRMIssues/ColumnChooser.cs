...
namespace TRMIssues
{
    ...
    public partial class ColumnChooser : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.FormsResources.ErrorColumnRequiredMessage, Resources.FormsResources.ErrorColumnRequiredTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
